class TransactionBuilder_Local_Usage {
    ...
    init(recipientSetter: IRecipientSetter, inputSetter: IInputSetter, outputSetter: IOutputSetter, signer: TransactionSigner_Local_Usage) {
...
extension TransactionBuilder_Local_Usage: ITransactionBuilder {
